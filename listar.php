...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navegacion-fm">
					<ul class="nav navbar-nav">
						...
						<li><a href="cerrar.php"><span class="glyphicon glyphicon-remove"></span>Salir</a></li>						
					</ul>
	...
	<div class="container">
		<div class="row">		
			<a class="btn btn-success" data-toggle="modal" data-target="#nuevoUsu">Nuevo Contacto</a>
			<div style="float:right">
			<form action="busqueda.php" method="post">
			<div class="form-group" >
			<td><input type="text" name="buscar" size="28" placeholder="ingrese el nombre a buscar" maxlength="45" required=""></input>
			<input type="submit" name="buscar1"  value="Buscar"></input></td>
